...
This project explores Python object-oriented programming, showcasing the implementation of three interconnected classes that represent rectangles and squares. The code includes a custom test suite built with the `unittest` module to thoroughly test each class's functionality.

The three classes leverage various Python tools, including:
* Import
* Exceptions
* Private attributes
